...
public class APay_DashboardSaved_QB_POM extends APay_Baseclass {
	
	public WebDriver driver;

	public APay_DashboardSaved_QB_POM() {
		this.driver = APay_Baseclass.getDriver();
	}


	public void dashboard_QuoteAndBook() {
		...
		WebElement QuoteAndBook = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='btnQuote']")));
		String text = QuoteAndBook.getText();
